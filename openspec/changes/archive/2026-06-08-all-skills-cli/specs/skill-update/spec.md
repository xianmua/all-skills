...
- **WHEN** user executes `all-skills update fmt`
...
- **WHEN** user executes `all-skills update nonexistent`
...
- **WHEN** user executes `all-skills update --all`
...
- **WHEN** user executes `all-skills update fmt --check`
