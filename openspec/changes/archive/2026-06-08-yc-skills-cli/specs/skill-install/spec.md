...
- **WHEN** user executes `yc-skills install fmt --trae`
...
- **WHEN** user executes `yc-skills install nonexistent`
...
- **WHEN** user executes `yc-skills install fmt --dir ./custom-skills`
