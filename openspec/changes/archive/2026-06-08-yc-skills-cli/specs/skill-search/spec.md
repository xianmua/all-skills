...
- **WHEN** user executes `yc-skills search fmt`
...
- **WHEN** user executes `yc-skills search nonexistent-keyword`
...
- **WHEN** user executes `yc-skills list`
...
- **WHEN** user executes `yc-skills search openspec`
